...
//
// WDL vs. Search6: 221+ 629= 150-
// time: 100
//

public class Search_7 : Search
{
    public override string ToString() { return "Search_7"; }
    ...
    private int negaMax(int alpha, int beta, int depth)
    {
        ...
        int ttFlag = localBestScore >= beta ? 3 : localBestScore <= alpha ? 2 : 1;
